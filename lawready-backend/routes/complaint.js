...
피고소인은 ${userDetails.transaction_date} 중고거래 사이트인 ${userDetails.site_name}에서, ${userDetails.transaction_item}(이하 '본 중고거래 대상물')를 판매한다는 글을 보고 연락해온 고소인에게 정상적인 본 중고거래 대상물을 판매하겠다고 아래와 같이 거짓말을 하였습니다.

사실 피고소인은 정상적으로 작동되는 물건이 없거나 아예 물건이 없어서 돈을 받더라도 정상적인 본 중고거래 대상물을 교부할 의사나 능력이 없었습니다.

고소이유

1. 상기 본인은 피고소인과 ${userDetails.transaction_date}에 ${userDetails.site_name} 사이트의 판매글을 보고 알게 되어 사이트 내부 메신저를 통해 연락을 주고 받았습니다.
...
1. 고소인과 피고소인은 사건이 발생한 ${userDetails.incident_date}, 인터넷 커뮤니티 사이트 ${userDetails.website}의 이용자들이었습니다.

2. 당시 피고소인은 다수의 불특정 이용자들이 접속할 수 있는 위 인터넷 커뮤니티 사이트에서 고소인에게 "${userDetails.offensive_comment}"라고 하며 고소인을 공연히 모욕하였습니다.
...
나. 본 사건이 발생한 ${userDetails.incident_date} 당시 해당 사이트는 고소인과 피고소인을 포함한 불특정 다수의 이용자들에게 공개되어 있었으며, 피고소인은 그들이 지켜보는 가운데 "${userDetails.offensive_comment}"라는 언행으로써 공연히 고소인에 대한 모욕을 입혔고, 당시 다른 이용자들은 고소인과 같은 서비스를 이용하는 관계에 불과할 뿐 고소인에 대한 소문을 비밀로 지켜줄만한 특별한 신분관계는 없었던 만큼, 피고소인의 모욕행위는 명백히 불특정 다수에게 전파될 가능성을 내포하고 있다할 것이므로 공연성 요건 역시 충족하고 있습니다.
...
2. 당시 피고소인은 고소인에게 "${userDetails.offensive_comment}"라고 하며, 고소인을 공연히 희롱하였는데, 이는 당시 ${userDetails.incident_location}에 있던 ${userDetails.people}의 사람이 함께 있었습니다.
...
2. 당시 피고소인은 고소인에게 ${userDetails.facts}를 하였습니다.
