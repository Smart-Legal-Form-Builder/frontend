...
final Map<String, List<Map<String, String>>> categoryFields = {
  '중고거래 사기': [
    ...
    {'label': '상대방 이름', 'placeholder':'사기 행위를 저지른 상대방의 이름을 입력해주세요. 모르면 모름으로 적어주세요 :)', 'key': 'defendant_name', 'category': '상대방 정보'},
    {'label': '상대방 전화번호', 'placeholder':'사기 행위를 저지른 상대방의 전화번호를 입력해주세요. 모르면 모름으로 적어주세요 :)', 'key': 'defendant_phone', 'category': '상대방 정보'},
  ...
  '성희롱': [
    ...
    {'label': '가해자 주소', 'placeholder':'성희롱을 저지른 상대방의 소재지를 입력해주세요. 모르면 모름으로 적어주세요 :)', 'key': 'defendant_address', 'category': '상대방 정보'},
    {'label': '가해자 전화번호', 'placeholder':'성희롱을 저지른 상대방의 전화번호를 입력해주세요. 모르면 모름으로 적어주세요 :)', 'key': 'defendant_phone', 'category': '상대방 정보'},
    {'label': '사건 일자', 'placeholder':'성희롱을 당한 날짜를 입력해주세요.', 'key': 'incident_date', 'category': '사건 내용'},
    {'label': '사건 장소', 'placeholder':'ex) 서울 여의도 소재 IFC몰 식당가', 'key': 'incident_location', 'category': '사건 내용'},
  ...
  '강제추행': [
    ...
    {'label': '주소', 'placeholder':'피해자 본인의 소재지를 입력해주세요.', 'key': 'complainant_address', 'category': '피해자 정보'},
    {'label': '전화번호', 'placeholder':'피해자 본인의 전화번호를 입력해주세요.', 'key': 'complainant_phone', 'category': '피해자 정보'},
    {'label': '가해자 이름', 'placeholder':'강제추행을 저지른 상대방의 이름을 입력해주세요. 모르면 모름으로 적어주세요 :)', 'key': 'defendant_name', 'category': '상대방 정보'},
    ...
    {'label': '피해 사실', 'placeholder':'ex) "지속적으로 다리를 쓰다듬는 행위" 형식으로 적어주세요.', 'key': 'facts', 'category': '사건 내용'},
    {'label': '고소 날짜', 'placeholder':'고소를 신청할 날짜를 입력해주세요.', 'key': 'report_date', 'category': '고소 정보'},
    {'label': '관할 경찰서', 'placeholder':'고소를 신청할 관할 경찰서 명을 입력해주세요.', 'key': 'police_station', 'category': '고소 정보'},
  ],
};
